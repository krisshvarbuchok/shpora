...
const LazyAndSuspense = () =>{
    ...
    return(
        <>
            ...
            <div><NavLink to="lazyComponent" className={({isActive}) => (isActive ? 'active' : 'router-item' )}>Lazy</NavLink></div>
            <div><NavLink to="suspenseComponent" className={({isActive}) => (isActive ? 'active' : 'router-item')} >Suspense</NavLink></div>
